    ...
    return (
        <Card className="mb-4">
            <Card.Body className="d-flex justify-content-between align-items-center">
                ...
                />
                <Card.Text className="m-0 sub__heading__5 text-truncate">invoice #{detail.invoice}</Card.Text>
                <Card.Text className="m-0 sub__heading__5">{ formatCurrency(detail.total) }</Card.Text>
                <Button variant="success" size="sm" onClick={() => handleDetailInvoice(detail.invoice)}>
